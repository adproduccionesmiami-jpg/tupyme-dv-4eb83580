...
export function InventoryFooter({ filteredCount, totalCount, products }: InventoryFooterProps) {
  ...
  return (
    <div className="mt-6 flex flex-col sm:flex-row items-center justify-between gap-3 px-4 py-3 bg-card border border-border/50 rounded-xl text-sm shadow-card">
